...
;(function ( $, window, document, undefined ) {
		...
		Plugin.prototype = {
			init: function () {
				...
				e.template += "<x:DisplayGridlines/></x:WorksheetOptions></x:ExcelWorksheet></x:ExcelWorksheets></x:ExcelWorkbook></xml><![endif]--> <meta http-equiv=\"content-type\" content=\"application/vnd.ms-excel; charset=UTF-8\">  </head><body><table>{table}</table></body></html>";
				e.tableRows = "";
